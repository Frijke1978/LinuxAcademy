...
psql postgres://name:password@34.243.213.5:80/sample -c "SELECT count(id) FROM employees;"

psql postgres://name:password@34.254.154.82:80/sample -c "SELECT count(id) FROM employees;"
